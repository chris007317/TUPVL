  ...
  <section class="content-header">
    <div class="container-fluid"> 
      <div class="row mb-2">
        <div class="col-sm-6">
          <div class="d-sm-flex">
            <h1 class="mr-2">Nuevo beneficiario</h1>              
            ...
            <button type="button" id="btnAgregarSocio" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalSocio">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Nuevo beneficiario</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
              ...
              <div class="col-sm-12 rounded-bottom p-2">
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 col-12"> 
                    <h6 ><b>Otros:</b> 
                    <div>
                      <button class="btn btn-primary btn-sm" id="btnLimpiarSocio"><i class="fas fa-trash-alt"></i> Limpiar</button>
                    </div></h6>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Datos del beneficiarios</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fas fa-minus"></i></button>
              </div>
            ...
            <div class="card-body">
              <form id="formPostulante" method="POST">
                <div class="col-sm-12 d-sm-flex p-0">
                  <div class="col-md-6 col-sm-6 col-12 p-2">
                    <div class="row">
                      <div class="form-group col-md-6 mb-3">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control mr-1" placeholder="DNI" maxlength="8" name="txtDniPostulante">
                          <button type="button" class="btn btn-primary" id="buscarPostulante">Buscar</button>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-6">
                        <label>Nombres *</label>
                        <input type="text" placeholder="Nombres" class="form-control" name="txtNombresPost" readonly>
                      </div>
                    </div>
                    <hr>
                    <div class="row">
                  ...
                  <div class="col-md-6 col-sm-6 col-12 p-2">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control select2" name="cmbTipoPostulante" id="cmbTipoPostulante" style="width: 100%;"  required>
                          ...
                          <?php foreach ($tipoBeneficiario as $key => $value): ?>
                            <option value="<?php echo $value['idTipoBeneficiario']; ?>" tiempoMeses="<?php echo $value['tiempoMeses']; ?>" inicioEdad="<?php echo $value['inicioEdad']; ?>" finEdad="<?php echo $value['finEdad']; ?>"><?php echo $value['nombreTipoBeneficiario']; ?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                      <div class="form-group col-md-6">
                    ...
                    <div class="row" id="madres" style="display: none;">
                      <div class="form-group col-md-6">
                          <label>Meses **</label>
                ...
                <input type="hidden" name="mesesMaximo">
                <div class="w-100">
                ...
                <?php 
                  $registrarBeneficiario = new ControladorBeneficiario();
                  $registrarBeneficiario->ctrRegistrarBeneficiario(); 
                ?>
              </form>
            </div>
            <div class="card-footer p-0 pl-2">
              <p class="text-dark">
                <strong>(*)</strong> Campos obligartorios <br>
                <strong>(**)</strong> Campos no obligarorios <br>
                <strong>Importante: </strong> Los nuevos beneficiarios solo podran ser programados para la recepción de alimentos desde la fecha de su inscripción.
              </p>
            </div>
            <!-- /.card-body -->
          </div>
